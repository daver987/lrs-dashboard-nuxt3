<template>
  <div>
    <input
      ...
      class="controls"
      type="text"
      placeholder="Enter an pickup location"
    />
    ...
    this.directionsService.route(
      ...
      (response, status) => {
        if (status === 'OK') {
          ...
          startAddress.value = response.routes[0].legs[0].start_address
          endAddress.value = response.routes[0].legs[0].end_address
        } else {
